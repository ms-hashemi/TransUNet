...
python train.py --dataset Design --img_size 64 --vit_grid 4 --vit_name Conv-ViT-Gen2-B_16 --gpu 4 --batch_size 64 # Main training code
...
python test.py --dataset Design2 --img_size 64 --vit_grid 4 --vit_name Conv-ViT-Gen2-B_16 --gpu 4 --batch_size 64 --batch_size_test 64 # Main testing/inference code

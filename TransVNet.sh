...
python train.py --dataset Design --img_size 64 --vit_patches_size 4 --vit_name Conv-ViT-Gen2-B_16 --gpu 4 --batch_size 128 # --pretrained_net_path '../model/TVG_Design[64, 64, 64]/TVG_encoderpretrained_Conv-ViT-Gen-B_16_vitpatch[4, 4, 4]_epo100_bs32_lr0.01_seed1234/epoch_99.pth'# Main training code
python test.py --dataset Design2 --img_size 64 --vit_patches_size 4 --vit_name Conv-ViT-Gen2-B_16 --gpu 4 --batch_size 128 --batch_size_test 128

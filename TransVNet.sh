...
python train.py --dataset Degradation --img_size 64 --vit_patches_size 8 --vit_name ViT-Gen2-B_16 --gpu 4 --batch_size 64 --base_lr 0.01 --max_epochs 5 --is_encoder_pretrained True #--pretrained_net_path '../model/TVG_Design[64, 64, 64]/TVG_encoderpretrained_Conv-ViT-Gen2-B_16_vitpatch[4, 4, 4]_epo100_bs64_lr0.01_seed1234/epoch_99.pth'
python test.py --dataset Degradation --img_size 64 --vit_patches_size 8 --vit_name ViT-B_16 --gpu 4 --batch_size 64 --base_lr 0.01 --max_epochs 5 --is_encoder_pretrained True --batch_size_test 64 # --net_path '../model/TVG_Design[64, 64, 64]/TVG_Conv-ViT-Gen2-B_16_vitpatch[1, 1, 1]_epo200_bs60_lr0.001_seed1234/epoch_39.pth'

...
# python train.py --dataset Degradation --img_size 160 --vit_patches_size 2 --vit_name Conv-ViT-B_16 --gpu 4 --batch_size 16 --base_lr 0.01 --max_epochs 4 --is_encoder_pretrained False --pretrained_net_path '../model/TVD_Degradation[64, 64, 64]/TVD_Conv-ViT-B_16_vitpatch[2, 2, 2]_epo4_bs48_lr0.01_seed1234/epoch_3.pth'
python test.py --dataset Degradation --img_size 160 --vit_patches_size 2 --vit_name Conv-ViT-B_16 --gpu 4 --batch_size 16 --base_lr 0.01 --max_epochs 4 --is_encoder_pretrained False --pretrained_net_path '../model/TVD_Degradation[64, 64, 64]/TVD_Conv-ViT-B_16_vitpatch[2, 2, 2]_epo4_bs48_lr0.01_seed1234/epoch_3.pth' --batch_size_test 16 --net_path '../model/TVD_Degradation[160, 160, 160]/TVD_pretrained_Conv-ViT-B_16_vitpatch[2, 2, 2]_epo4_bs16_lr0.01_seed1234/epoch_0.pth'

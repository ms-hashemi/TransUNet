...
python train.py --dataset Degradation --img_size 64 --vit_patches_size 8 --vit_name ViT-B_16 --gpu 4 --batch_size 64 --base_lr 0.01 --max_epochs 5 --is_encoder_pretrained True #--pretrained_net_path '../model/TVG_Design[64, 64, 64]/TVG_encoderpretrained_Conv-ViT-Gen2-B_16_vitpatch[4, 4, 4]_epo100_bs64_lr0.01_seed1234/epoch_99.pth'

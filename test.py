...
def inferrer_mat2(args, model, test_save_path=None):
    ...
    for i_batch, sampled_batch in tqdm(enumerate(testloader)):
        ...
        for i in range(len(name_batch)):
            ...
            logging.info('name %7s surrogate_model_error %13.6f generative_error %13.6f reconstruction_loss %13.6f C11 %13.6f C11_predicted %13.6f C11_error %13.6f C12 %13.6f C12_predicted %13.6f C12_error %13.6f C13 %13.6f C13_predicted %13.6f C13_error %13.6f C33 %13.6f C33_predicted %13.6f C33_error %13.6f C44 %13.6f C44_predicted %13.6f C44_error %13.6f C66 %13.6f C66_predicted %13.6f C66_error %13.6f e31 %13.6f e31_predicted %13.6f e31_error %13.6f e33 %13.6f e33_predicted %13.6f e33_error %13.6f e15 %13.6f e15_predicted %13.6f e15_error %13.6f gamma11 %13.6f gamma11_predicted %13.6f gamma11_error %13.6f gamma33 %13.6f gamma33_predicted %13.6f gamma33_error %13.6f' % formatting_tuple)
